...
export default function AboutSection() {
  return (
    <section id="about" style={{ padding: '10rem 0', position: 'relative', background: 'transparent' }}>
      <div className="container">
        <motion.div 
          ...
          style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '6rem', alignItems: 'center' }}
        >
          <div>
            <p style={{ 
              color: '#a09080', 
            ...
            {/* Skill areas with elegant separators */}
            <div style={{ borderTop: '1px solid rgba(61, 53, 40, 0.1)', paddingTop: '2rem' }}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
                <div>
                  ...
                  <p style={{ 
                    ...
                    React, Next.js,<br/>TypeScript, Node.js
                  </p>
                </div>
                <div>
                  <h4 style={{ 
                  ...
                  <p style={{ 
                    ...
                    Three.js, WebGL,<br/>GSAP, Framer Motion
                  </p>
                </div>
              </div>
            </div>
